...
<div class="container py-5" style="max-width: 820px;">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        <div>
            ...
            <p style="color:rgba(200,197,255,.5);font-size:.9rem;margin:0;">7 tâches au total</p>
        </div>
    ...
    <div class="mb-4">
        <div class="cat-header">
            ...
            <span class="cat-name">Économique</span>
            <span class="cat-count">2 tâches</span>
        </div>
        <div class="d-flex flex-column gap-2">

            <div class="task-row">
                <i class="bi bi-check-circle-fill fs-5" style="color:var(--cyan)"></i>
                <div class="flex-grow-1">
                    <div class="task-title done">Payer la facture EDF</div>
                    <div class="task-date">Créée le 10/02/2026 — Fin le 15/02/2026</div>
                </div>
                <span class="badge badge-done rounded-pill px-2">✅ Terminé</span>
                <div class="d-flex gap-2">
            ...
            <div class="task-row">
                <i class="bi bi-circle fs-5" style="color:rgba(200,197,255,.25)"></i>
                <div class="flex-grow-1">
                    <div class="task-title">Revoir le budget mensuel</div>
                    <div class="task-date">Créée le 12/02/2026 — Fin le 28/02/2026</div>
                </div>
                <span class="badge badge-todo rounded-pill px-2">⭕ Pas commencé</span>
                <div class="d-flex gap-2">
                    <button class="btn-action btn-edit"><i class="bi bi-pencil"></i> Modifier</button>
                    <button class="btn-action btn-show"><i class="bi bi-eye"></i> Afficher</button>
                    <button class="btn-action btn-delete"><i class="bi bi-trash"></i> Supprimer</button>
    ...
    <div class="mb-4">
        <div class="cat-header">
            <span class="cat-emoji">🏠</span>
            <span class="cat-name">Ménagère</span>
            <span class="cat-count">3 tâches</span>
        </div>
        <div class="d-flex flex-column gap-2">

            <div class="task-row">
                <i class="bi bi-record-circle fs-5" style="color:var(--sky)"></i>
                <div class="flex-grow-1">
                    <div class="task-title">Nettoyer la cuisine</div>
                    <div class="task-date">Créée le 14/02/2026 — Fin le 17/02/2026</div>
                </div>
                <span class="badge badge-going rounded-pill px-2">🔵 En cours</span>
                <div class="d-flex gap-2">
                    <button class="btn-action btn-edit"><i class="bi bi-pencil"></i> Modifier</button>
                    <button class="btn-action btn-show"><i class="bi bi-eye"></i> Afficher</button>
                    <button class="btn-action btn-delete"><i class="bi bi-trash"></i> Supprimer</button>
            ...
            <div class="task-row">
                <i class="bi bi-circle fs-5" style="color:rgba(200,197,255,.25)"></i>
                <div class="flex-grow-1">
                    <div class="task-title">Faire les courses</div>
                    <div class="task-date">Créée le 15/02/2026 — Fin le 18/02/2026</div>
                </div>
                <span class="badge badge-todo rounded-pill px-2">⭕ Pas commencé</span>
                <div class="d-flex gap-2">
                    <button class="btn-action btn-edit"><i class="bi bi-pencil"></i> Modifier</button>
            ...
            <div class="task-row">
                <i class="bi bi-check-circle-fill fs-5" style="color:var(--cyan)"></i>
                <div class="flex-grow-1">
                    <div class="task-title done">Laver le linge</div>
                    <div class="task-date">Créée le 13/02/2026 — Fin le 14/02/2026</div>
                </div>
                <span class="badge badge-done rounded-pill px-2">✅ Terminé</span>
                <div class="d-flex gap-2">
                    <button class="btn-action btn-edit"><i class="bi bi-pencil"></i> Modifier</button>
    ...
    <div class="mb-4">
        <div class="cat-header">
            <span class="cat-emoji">💼</span>
            <span class="cat-name">Professionnelle</span>
            <span class="cat-count">2 tâches</span>
        </div>
        <div class="d-flex flex-column gap-2">
            ...
            <div class="task-row">
                <i class="bi bi-record-circle fs-5" style="color:var(--sky)"></i>
                <div class="flex-grow-1">
                    <div class="task-title">Préparer la présentation</div>
                    <div class="task-date">Créée le 16/02/2026 — Fin le 20/02/2026</div>
                </div>
                <span class="badge badge-going rounded-pill px-2">🔵 En cours</span>
                <div class="d-flex gap-2">
                    <button class="btn-action btn-edit"><i class="bi bi-pencil"></i> Modifier</button>
            ...
            <div class="task-row">
                <i class="bi bi-circle fs-5" style="color:rgba(200,197,255,.25)"></i>
                <div class="flex-grow-1">
                    <div class="task-title">Répondre aux emails clients</div>
                    <div class="task-date">Créée le 17/02/2026 — Fin le 17/02/2026</div>
                </div>
                <span class="badge badge-todo rounded-pill px-2">⭕ Pas commencé</span>
                <div class="d-flex gap-2">
                    <button class="btn-action btn-edit"><i class="bi bi-pencil"></i> Modifier</button>
    ...
    <div class="mb-4">
        <div class="cat-header">
            <span class="cat-emoji">🌱</span>
            <span class="cat-name">Personnelle</span>
            <span class="cat-count">0 tâche</span>
        </div>
